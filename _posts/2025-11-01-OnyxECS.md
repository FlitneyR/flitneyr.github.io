...
Though not traditionally used in games, it has gained traction as of late, as an alternative to the Actor/GameObject architecture.
In this article I'll try and explain a bit about why I chose an ECS for my engine; how it is used in Onyx; and how I have
gone about implementing it.
...
order, and without writing to memory that another system is reading. Ideally we would have a [better solution to scheduling concerns](#system-scheduling).
...
This approach has some benefits, and some drawbacks. Most of which I think could be alleviated by [paging components](#paging).
