...
classDiagram
    ...
    class ComponentTable~Component~ {
        -Map~Entity,Component~ components
    ...
    QuerySet --> QueryManager : gets queries from
    ...
    System --> QuerySet : requests queries from
    System --> Result : iterates over
    SystemSet --* System : contains
</pre>
